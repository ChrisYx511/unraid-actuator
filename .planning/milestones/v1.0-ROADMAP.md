...
**Success Criteria** (what must be TRUE):
  ...
  3. Every successful built environment contains a normalized `docker-compose.yml` regardless of whether the source came from a static Compose file or the declarative template/value workflow.
