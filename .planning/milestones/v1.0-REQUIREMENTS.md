...
- [x] **BLD-04**: Operator gets a normalized `docker-compose.yaml` for every built environment regardless of whether the source came from a static Compose file or the shipped template/value workflow
